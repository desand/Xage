...
<body class="login">
  <!-- BEGIN LOGO -->
  <div class="logo">
    <img src="<?php echo __BASEURL__?>templates/assets/img/logo-big.png" alt="" /> 
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  <div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="form-vertical login-form" action="<?php echo site_url('admin/user/login');?>" method="post">
      ...
      <div class="control-group">
        <label class="control-label visible-ie8 visible-ie9">ValidateCode</label>
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-lock"></i>
            <input class="m-wrap placeholder-no-fix" style="width:160px" type="text" placeholder="ValidateCode" name="validatecode"/>
            <img style="height:32px" src="<?php echo site_url('index/validatecode');?>" onclick="javascript:this.src='<?php echo site_url('index/validatecode');?>?tm='+Math.random();" />
          </div>
        </div>
      </div>
    ...
    <form class="form-vertical register-form" action="index.html">
      ...
      <div class="form-actions">
        ...
        <button type="submit" id="register-submit-btn" class="btn green pull-right" name="submit">
  ...
  <script src="<?php echo __BASEURL__?>templates/assets/uniform/jquery.uniform.min.js"></script> 
  <script src="<?php echo __BASEURL__?>templates/assets/js/jquery.blockui.js"></script>
  <script type="text/javascript" src="<?php echo __BASEURL__?>templates/assets/jquery-validation/dist/jquery.validate.min.js"></script>
